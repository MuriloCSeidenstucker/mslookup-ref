...
class MedicinesEntity(Base):
    ...
    medicine_id = Column(Integer, primary_key=True, autoincrement=False)
    ...
    def __repr__(self):
        return f"Medicines [medicine_id={self.medicine_id}, product={self.product}, laboratory={self.laboratory}]"
